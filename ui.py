...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.closed_combobox.setGeometry(QRect(70, 122, 171, 32))
        ...
        self.open_combobox.setGeometry(QRect(71, 80, 171, 32))
        self.open_combobox.setCursor(QCursor(Qt.PointingHandCursor))
        self.open_combobox.setAcceptDrops(False)
        self.label_3 = QLabel(self.centralwidget)
        self.label_3.setObjectName(u"label_3")
        self.label_3.setGeometry(QRect(15, 122, 49, 31))
        self.label_4 = QLabel(self.centralwidget)
        self.label_4.setObjectName(u"label_4")
        self.label_4.setGeometry(QRect(20, 80, 45, 32))
        self.label = QLabel(self.centralwidget)
        self.label.setObjectName(u"label")
        self.label.setGeometry(QRect(29, 198, 35, 32))
        self.label_2 = QLabel(self.centralwidget)
        self.label_2.setObjectName(u"label_2")
        self.label_2.setGeometry(QRect(11, 160, 53, 31))
        ...
        self.ok_combobox.setGeometry(QRect(70, 198, 171, 32))
        ...
        self.pointer_combobox.setGeometry(QRect(70, 160, 171, 32))
        ...
        self.pushButton.setGeometry(QRect(30, 260, 211, 41))
        self.pushButton_2 = QPushButton(self.centralwidget)
        self.pushButton_2.setObjectName(u"pushButton_2")
        self.pushButton_2.setGeometry(QRect(30, 310, 211, 41))
        self.open_combobox_2 = QComboBox(self.centralwidget)
        self.open_combobox_2.setObjectName(u"open_combobox_2")
        self.open_combobox_2.setGeometry(QRect(80, 0, 171, 32))
        self.open_combobox_2.setCursor(QCursor(Qt.PointingHandCursor))
        self.open_combobox_2.setAcceptDrops(False)
        self.label_6 = QLabel(self.centralwidget)
        self.label_6.setObjectName(u"label_6")
        self.label_6.setGeometry(QRect(20, 0, 61, 32))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_6.setText(QCoreApplication.translate("MainWindow", u"\u041f\u0440\u043e\u0444\u0438\u043b\u044c", None))
    # retranslateUi
