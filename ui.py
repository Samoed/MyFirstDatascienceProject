...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.two_fingers_combobox.addItem("")
        self.two_fingers_combobox.addItem("")
        self.two_fingers_combobox.setObjectName(u"two_fingers_combobox")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.l_combobox.setItemText(0, QCoreApplication.translate("MainWindow", u"Move mouse", None))
        self.l_combobox.setItemText(1, QCoreApplication.translate("MainWindow", u"Left mouse (LMB)", None))
        self.l_combobox.setItemText(2, QCoreApplication.translate("MainWindow", u"Right mouse", None))
        ...
        self.two_fingers_combobox.setItemText(0, QCoreApplication.translate("MainWindow", u"Mouse move", None))
        self.two_fingers_combobox.setItemText(1, QCoreApplication.translate("MainWindow", u"Left mouse (LMB)", None))
        self.two_fingers_combobox.setItemText(2, QCoreApplication.translate("MainWindow", u"Right mouse", None))
        ...
        self.one_combobox.setItemText(0, QCoreApplication.translate("MainWindow", u"Mouse move", None))
        self.one_combobox.setItemText(1, QCoreApplication.translate("MainWindow", u"Left click (LMB)", None))
        self.one_combobox.setItemText(2, QCoreApplication.translate("MainWindow", u"Right click", None))
